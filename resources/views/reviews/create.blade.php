<x-app-layout>
  <x-review-frame store="なんばスカイオ店" account="Account No.0001" active="create">
        ...
        <div class="review-field">
          ...
          <div class="review-select-wrap">
            <select id="status" name="status" class="review-select">
              <option value="available">まだある</option>
              <option value="soldout">もうない</option>
            </select>
